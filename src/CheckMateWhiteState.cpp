...
CheckMateWhiteState::CheckMateWhiteState(StateStack& stack, Context context)
: State(stack, context)
, mPausedText()
{
	mShowText = true;
...
CheckMateWhiteState::~CheckMateWhiteState()
{
}

void CheckMateWhiteState::draw()
{
...
bool CheckMateWhiteState::update(sf::Time dt)
{
	mTextEffectTime += dt;
...
bool CheckMateWhiteState::handleEvent(const sf::Event& event)
{
