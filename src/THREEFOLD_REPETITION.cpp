...
THREEFOLDREPETITION::THREEFOLDREPETITION(StateStack& stack, Context context)
	: State(stack, context)
	, mPausedText()
{
	mShowText = true;
	...
	mPausedText.setString("Threefold repetition!");
...
bool THREEFOLDREPETITION::update(sf::Time dt)
{
	mTextEffectTime += dt;
...
bool THREEFOLDREPETITION::handleEvent(const sf::Event& event)
{
