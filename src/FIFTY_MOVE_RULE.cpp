...
FIFTYMOVERULE::FIFTYMOVERULE(StateStack& stack, Context context)
	: State(stack, context)
	, mPausedText()
{
	mShowText = true;
	...
	mPausedText.setString("Fifty move rule!");
...
bool FIFTYMOVERULE::update(sf::Time dt)
{
	mTextEffectTime += dt;
...
bool FIFTYMOVERULE::handleEvent(const sf::Event& event)
{
