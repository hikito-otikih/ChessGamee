#ifndef BOOK_CHESSGAME1PLAYERSTATE_HPP
#define BOOK_CHESSGAME1PLAYERSTATE_HPP
...
class ChessGame1PlayerState : public State
{
public:
	ChessGame1PlayerState(StateStack& stack, Context context);
	virtual void		draw();
